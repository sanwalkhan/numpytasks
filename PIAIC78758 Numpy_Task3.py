...
rate=(54*100)/10000
rate
possible_surveys = np.random.binomial(np.count_nonzero(survey_responses), rate , 10000 )
possible_surveys
...
rate=(54*100)/10000
rate
large_survey = np.random.binomial(np.count_nonzero(survey_responses), rate,7000)/7000
large_survey
